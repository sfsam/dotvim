...
hi Normal           guifg=#000000  guibg=#f6f6ee  gui=none   ctermfg=0     ctermbg=231
hi NonText          guifg=#dddddd  guibg=#f6f6ee  gui=none   ctermfg=0     ctermbg=231
hi TabLine          guifg=#666666  guibg=#cfcfcf  gui=none   ctermfg=239   ctermbg=251
hi TabLineSel       guifg=#000000  guibg=#f6f6ee  gui=bold   ctermfg=0     ctermbg=NONE
...
hi LineNr           guifg=#cccccc  guibg=#f6f6ee  gui=none   ctermfg=249   ctermbg=NONE
hi CursorLineNR     guifg=#2e9dff  guibg=#f0f8ff  gui=bold   ctermfg=NONE  ctermbg=NONE  cterm=bold
hi CursorLine       guifg=NONE     guibg=#c4c3bd  gui=none   ctermfg=NONE  ctermbg=231   cterm=none
...
hi Search           guifg=NONE     guibg=#ffd9e4  gui=none   ctermfg=NONE  ctermbg=229
hi StatusLine       guifg=#f6f6ee  guibg=#55554f  gui=none   ctermfg=239   ctermbg=255
hi StatusLineNC     guifg=#969696  guibg=#e8e8e1  gui=none   ctermfg=249   ctermbg=NONE
hi StatusLineTerm   guifg=#f6f6ee  guibg=#646464  gui=none   ctermfg=239   ctermbg=255
hi StatusLineTermNC guifg=#969696  guibg=#f2f2f2  gui=none   ctermfg=249   ctermbg=NONE
hi WildMenu         guifg=#646464  guibg=#f6f6ee  gui=none   ctermfg=238   ctermbg=255
hi Pmenu            guifg=#000000  guibg=#d7bdff  gui=none   ctermfg=0     ctermbg=141
hi PmenuSel         guifg=#f6f6ee  guibg=#7a25fa  gui=none   ctermfg=15    ctermbg=54
